...
const brandStyles = {
  adidas:
    'sporty, dynamic, urban, street style, athletic, modern, bold, energetic',
  nike: 'athletic, dynamic, premium, innovative, bold, energetic, urban',
  puma: 'sporty, casual, street style, modern, vibrant, urban',
  default: 'professional, modern, clean, high-quality',
};
...
export async function POST(req: Request) {
  try {
    ...
    const brandStyle =
      brandStyles[brand as keyof typeof brandStyles] || brandStyles.default;
